...
func _ready() -> void:
	...
	add_child(preload("res://scripts/runtime/performance_monitors.gd").new()); add_child(preload("res://scripts/runtime/feedback_runtime.gd").new()) # release-build diagnostics children; self-register/read-only
