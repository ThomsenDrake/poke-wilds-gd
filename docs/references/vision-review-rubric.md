...
## Camping states (`15_camp_night_lit`, `16_craft_menu` — `17_dawn_after_rest` is formally RETIRED: camping-reserved, never committed; farfield owns shot 42 while retired 43 stays reserved with 17/33/35/36)
