...
5. **Graduate the pixel lint**: flip `GRADUATED` (`ui_render_audit.gd:14`) to true once baseline churn from Phases 1–3 settles; until then every phase adds baselines for its new states.
