...
- The gated suite is 66 scenarios (53 playtest + 13 smoke); the canonical lists are `PLAYTEST_SCENARIOS`/`SMOKE_SCENARIOS` in `tools/run_playtests.py` — cite them instead of re-enumerating them here.
