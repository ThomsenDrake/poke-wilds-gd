...
PLAYTEST_SCENARIOS = ["playtest_journey", "playtest_soak", "nav_audit", "texture_audit", "data_audit", "layout_audit", "world_consistency_audit", "ui_render_audit", "ui_tree_dump", "legibility_soak", "feedback_flow", "battle_anim", "display_matrix", "harvest_flow", "placement_flow", "input_gate", "battle_end_input", "dig_silence", "storage_flow", "camp_survival", "craft_flow", "night_cycle", "time_evolution", "field_moves_flow", "build_house_flow", "breed_flow", "shiny_odds", "habitat_drops", "fishing_flow", "overworld_mons", "encounter_config", "world_gen_audit", "landmark_flow", "legendary_spawn", "legendary_dungeon", "waystone_selector", "content_scatter", "seed_choice", "new_game_flow", "playtest_breed_soak", "playtest_field_soak", "rng_joint_pin", "save_stability", "playtest_entity_soak", "visual_sweep_fishing", "visual_sweep_fishing_update", "visual_sweep_world_depth", "visual_sweep_world_depth_update", "visual_sweep_farfield", "visual_sweep_farfield_update", "showcase_capture", "temporal_flow", "play_agent"]
SMOKE_SCENARIOS = [
    "boot",
    "overworld_step",
    "menu_save",
